    ...
    <div class="col-lg-9 col-12">
        ...
        <?php
            ...
            foreach ($news as $new) {
                ...
                echo "<br><br><p><span class='glyphicon glyphicon-time'></span> ".$sana."&nbsp;&nbsp;";
                echo "<span class='glyphicon glyphicon-eye-open'></span> ".$new->korishlar_soni."<a href='".\yii\helpers\Url::to(['site/'.$bolim])."'>&nbsp;&nbsp;#";
